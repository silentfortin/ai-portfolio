...
## 📌 Overview  
This project focuses on building a predictive model to estimate real estate prices using linear regression techniques with regularization.  
The goal is to improve generalization, mitigate overfitting, and produce reliable price predictions on housing data.  
...
The performance of these models is evaluated using cross-validation, error metrics, and model complexity (sparsity).
...
- Regularization improved generalization, reducing overfitting compared to the unregularized model.  
- Residual analysis showed the presence of heteroscedasticity, suggesting potential improvements using non-linear models or data transformations.
...
## ✅ Conclusions  
- Linear models with regularization are effective for housing price prediction on this dataset.  
